...
const Upload = () => {
  ...
  const handleFileChange = (event) => {
    ...
    if (file) {
      // Validate file type
      const allowedTypes = ['application/pdf', 'application/vnd.ms-powerpoint', 'application/vnd.openxmlformats-officedocument.presentationml.presentation', 'image/jpeg', 'image/png'];
  ...
  const handleSubmit = (event) => {
    ...
    // Here you would typically send the file and other data to a backend
    console.log('Uploading:', {
      file: selectedFile,
      title,
      subject,
      tags,
      folder: folder || newFolderName, // Use selected folder or new folder name
    });
    alert('File uploaded successfully (frontend simulation)!');
    // Reset form
    setSelectedFile(null);
    setTitle('');
    setSubject('');
    ...
    <div className="upload-container">
      <form className="upload-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input type="file" id="file" onChange={handleFileChange} accept=".pdf,.ppt,.pptx,.jpg,.png" />
        ...
        <div className="form-group">
          ...
          />
          <button type="button" onClick={handleAddFolder}>Create & Select</button>
        </div>
